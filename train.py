...
from policy_value_net_pytorch import PolicyValueNet  # 使用PyTorch
import torch
...
class TrainPipeline():
    def __init__(self, init_model=None, is_shown=0):
        # 五子棋逻辑和棋盘UI的参数
        self.board_width = 15  ###为了更快的验证算法，可以调整棋盘大小为(8x8) ，(6x6)
    ...
    def run(self):
        ...
        try:
            ...
            print('\n\rTraining interrupted. Saving current model...')
            self.policy_value_net.save_model(os.path.join(dst_path, 'interrupted_policy2.model'))
            print('Model saved.')
            print('\n\rquit')
...
if __name__ == '__main__':
    ...
    model_path = 'dist/interrupted_policy1.model'
